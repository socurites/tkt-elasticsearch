...
public class TktKoreanTokenizerTest {
	...
	private Tokenizer createTokenizer(StringReader reader, boolean disableNormalize, boolean disableStemmer) {
		Tokenizer tokenizer = new TktKoreanTokenizer(reader, disableNormalize, disableStemmer);
